<#
.SYNOPSIS
    VampKit Tweak Database v7.3.1 - Declarative registry/service tweak definitions.
...
# --- PROJECT VAMPKIT: TWEAK DATABASE v7.3.1 (SHOGUN EDITION) ---
        ...
        Apply={ 
            ...
            if ($SyncHash -and $SyncHash.Window) {
                $result = $SyncHash.Window.Dispatcher.Invoke([System.Func[String]] {
                    return [System.Windows.Forms.MessageBox]::Show($msg, "VampKit Bloatware Removal", [System.Windows.Forms.MessageBoxButtons]::YesNo, [System.Windows.Forms.MessageBoxIcon]::Warning).ToString()
                })
            } else {
                $result = [System.Windows.Forms.MessageBox]::Show($msg, "VampKit Bloatware Removal", [System.Windows.Forms.MessageBoxButtons]::YesNo, [System.Windows.Forms.MessageBoxIcon]::Warning).ToString()
            }
...
$TweakTips = @{
    ...
    "Sys_SysRestore"        = "Turns OFF System Restore to save disk space and background cycles. WARNING: this also disables VampKit's own Auto-Backup restore points - leave unchecked unless storage is critical."
